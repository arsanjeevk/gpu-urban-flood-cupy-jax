...
\begin{titlepage}
  ...
  \vspace{6mm}
  {\large\bfseries Dr. Udit Bhatia\par}
  \vspace{1mm}
  {\large Associate Professor, Indian Institute of Technology Gandhinagar\par}
...
\thispagestyle{empty}
I Mr. SANJEEV KUMAWAT, hereby declare that the details/facts mentioned above are true to the best of my knowledge, and I shall be solely held responsible in case any discrepancies are found in the details mentioned above.
...
\vspace{18mm}
\noindent Date: 15 September 2026\\
Place: Gandhinagar
\clearpage
...
\thispagestyle{empty}
I acknowledge the guidance of Dr. Udit Bhatia, the provision of the production domain and
